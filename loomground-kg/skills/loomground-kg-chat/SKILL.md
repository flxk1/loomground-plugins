...
description: Conversational, read-only Q&A over the Loomground Versum knowledge graph, grounded on every read, local-model-first. Concept multi-hop is claim/source-level until the concept layer is curated. Triggers - "what does this source ground", "which sources support this", "how are X and Y connected", "answer this from the KG".
---
