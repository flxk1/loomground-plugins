...
description: The Versum mental-model engine - scan content into a grounded ConceptGraph and project it to the format that answers the question. One hub over scan -> compose -> project, wrapping the versum engine; writes route through loomground-knowledge-write. Triggers - "build a mental model", "extract the concepts", "make a concept graph", "turn this into slides/a checklist/a diagram/SQL", "project this content as X".
---
